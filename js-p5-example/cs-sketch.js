...
var g_canvas = { cell_size:20, wid:64, hgt:32 }; // Looks nicer
var g_frame_cnt = 0; // Setup a P5 display-frame counter, to do anim
var g_frame_mod = 10; // Update ever 'mod' frames. //DEFAULT: 24
var g_stop = 0; // Used to stop the draw_update calls. Go by default.
...
function setup() // P5 Setup Fcn
{
	...
	draw_grid( 20, 100, 'white', 'yellow' ); // Looks nicer
}
...
function draw_bot( ) // Convert bot pox to grid pos & draw bot.
{
    ...
    else stroke( 'white' ); // Else Bot visiting this cell, so color it. //DEFAULT: white
